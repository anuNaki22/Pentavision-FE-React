...
const FinancingForm = ({ credit_amount, purpose }) => {
  const navigate = useNavigate();
  // const [credit_amount, setCredit] = creditState;
  useEffect(() => {
    setFormData((prev) => ({ ...prev, credit_amount: credit_amount || "" }));
  }, [credit_amount]);
    ...
    >
      <div className="flex justify-center items-center min-h-screen">
        <div className="max-w-2xl mx-auto p-6">
          <h2 className="text-3xl font-semibold text-center text-[#00696D] mb-8">
            Formulir Uji Kelayakan
          </h2>
          <form
          ...
          >
            ...
            <div className="col-span-2 flex items-center gap-3">
              ...
              />
              <label className="text-[#131927] text-base font-normal cursor-pointer">
                Saya setuju data saya disimpan untuk meningkatkan akurasi
                simulasi BSI.
              </label>
            </div>
