...
const Predict = () => {
    ...
    let check = JSON.parse(window.localStorage.getItem("result")) || { result: "null"};
                    ...
                    <div className="flex justify-center mb-4">
                        {result.result == "APPROVED"
                            ...
                            : <p id="result-string">
                                ...
                                Kamu bisa cek kembali opsi lain atau {' '}
                                <a href="mailto:bsifund@bankbsi.co.id" className="font-bold underline text-[#3E9EA2]">hubungi kami</a>
                                {' '}untuk solusi terbaik.
                                InsyaAllah, ada jalan yang berkah untukmu. ✨
                            </p>
                        }
                    </div>
                    {result.result == "APPROVED" && (
                        <>
                            ...
                            <div className="w-full text-[#3E9EA2]">
                                Desclaimer: Hasil di atas merupakan angka estimasi, untuk info lebih lanjut {' '}
                                <a href="mailto:bsifund@bankbsi.co.id" className="font-bold underline">
                                    hubungi kami
                                </a>
                                .
                            </div>
